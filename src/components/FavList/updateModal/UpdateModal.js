...
function UpdateModal( {show,handleClose,ele,getFavMovies,
   ...
   // console.log(titleInput);
    const update = async(id)=>{
        ...
        let updated = {title:titleInput, summary:ele.overview, image:poster_path, comment:commentInput}
        
      await axios.put(`https://newmoviesbybaraah.herokuapp.com/update/${id}`,updated)
                  .then(()=>{
                    getFavMovies();
                  }).catch(err=>{
                      console.log(err);
